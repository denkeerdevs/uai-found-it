...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/assets/admin/assets/bootstrap/dist/css/bootstrap.min.css">
...
<body>
    ...
    <!-- General JS Scripts -->
    <script src="<?= base_url() ?>/assets/admin/assets/jquery/dist/jquery.min.js"></script>
    <script src="<?= base_url() ?>/assets/admin/assets/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="<?= base_url() ?>/assets/admin/assets/jquery.nicescroll/dist/jquery.nicescroll.min.js"></script>
